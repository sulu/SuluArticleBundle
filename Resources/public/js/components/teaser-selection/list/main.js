 ...
 *
 * FIXME this file contains a copy of "teaser-selection/list@sulucontent" (missing url-parameter locale there)
 *
 * @class ListTeaser
 * @constructor
 */
            ...
            this.sandbox.start([
                ...
                },
                {
                    ...
                    options: {
                        ...
                        url: this.options.url + '?locale=' + this.options.locale,
