...
define(['type/default'], function(Default) {
    ...
    return function($el, options) {
        var defaults = {},
            ...
            subType = {
                initializeSub: function() {
                    var dataChangedEvent = 'sulu.article-selection.' + options.instanceName + '.data-changed';
                ...
                setValue: function(value) {
                    App.dom.data($el, 'article-selection', value);
                },

                getValue: function() {
                    return App.dom.data($el, 'article-selection');
                },
        ...
        return new Default($el, defaults, options, 'articleSelection', subType);
    };
});
